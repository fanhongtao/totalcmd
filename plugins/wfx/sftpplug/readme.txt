New secure ftp plugin version 1.4.1 (32 bit+64 bit)
Copyright (C) 2008-2013 Christian Ghisler, all rights reserved
...
20130304 Fixed: Password change via libssh2_userauth_password_ex would cause a crash (buffer deallocaion)
